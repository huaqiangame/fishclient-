! function(t, n) {
    "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define("StateMachine", [], n) : "object" == typeof exports ? exports.StateMachine = n() : t.StateMachine = n()
}(this, function() {
    return function(t) {
        function n(e) {
        ...
        t.exports = {
            build: function(t, n) {
                ...
                for (i = 0, s = o.length; i < s; i++)(r = o[i]).methods && e(t, r.methods), r.properties && Object.defineProperties(t, r.properties)
            },
            hook: function(t, n, i) {
                var e, s, r, o, a = t.config.plugins,
                    f = [t.context];
        ...
        t.exports = function(t) {
            var n, i = t.split(/[_-]/),
                e = i[0];
            for (n = 1; n < i.length; n++) e = e + i[n].charAt(0).toUpperCase() + i[n].substring(1);
            return e
        }
    }, function(t, n, i) {
        "use strict";
        ...
        s(e.prototype, {
            ...
            addStateLifecycleNames: function(t) {
                this.lifecycle.onEnter[t] = r("on-enter-" + t), this.lifecycle.onLeave[t] = r("on-leave-" + t), this.lifecycle.on[t] = r("on-" + t)
            },
            ...
            addTransitionLifecycleNames: function(t) {
                this.lifecycle.onBefore[t] = r("on-before-" + t), this.lifecycle.onAfter[t] = r("on-after-" + t), this.lifecycle.on[t] = r("on-" + t)
            },
            ...
            configureLifecycle: function() {
                return {
                    onBefore: {
                        transition: r("on-before-transition")
                    },
                    onAfter: {
                        transition: r("on-after-transition")
                    },
                    onEnter: {
                        state: r("on-enter-state")
                    },
                    onLeave: {
                        state: r("on-leave-state")
                    },
                    on: {
                        transition: r("on-transition")
                    }
                }
            },
            ...
            configurePlugins: function(t, n) {
                var i, e, s;
                for (i = 0, e = (t = t || []).length; i < e; i++) "function" == typeof(s = t[i]) && (t[i] = s = s()), s.configure && s.configure(this);
                return t
            },
            configureTransitions: function(t) {
                var n, i, e, s, r, o = this.defaults.wildcard;
                for (i = 0; i < t.length; i++)
                    for (e = t[i], s = Array.isArray(e.from) ? e.from : [e.from || o], r = e.to || o, n = 0; n < s.length; n++) this.mapTransition({
                        name: e.name,
                        from: s[n],
                        to: r
                    })
        ...
        s(e.prototype, {
            ...
            observersForEvent: function(t) {
                for (var n, i = 0, e = this.observers.length, s = []; i < e; i++)(n = this.observers[i])[t] && s.push(n);
                return [t, s, !0]
            },
            observeEvents: function(t, n, i) {
                if (0 === t.length) return this.endTransit(!0);
                var e = t[0][0],
                    s = t[0][1],
                    r = t[0][2];
                if (n[0].event = e, e && r && e !== i && o.hook(this, "lifecycle", n), 0 === s.length) return t.shift(), this.observeEvents(t, n, e);
                var a = s.shift(),
                    f = a[e].apply(a, n);
                return f && "function" == typeof f.then ? f.then(this.observeEvents.bind(this, t, n, e)).catch(this.endTransit.bind(this)) : !1 === f ? this.endTransit(!1) : this.observeEvents(t, n, e)
            },
        ...
        function s(t, n) {
            return r(t, new c(n, e)), t._fsm(), t
        }

        function r(t, n) {
            if ("object" != typeof t || Array.isArray(t)) throw Error("StateMachine can only be applied to objects");
            f.build(t, n), Object.defineProperties(t, l), o(t, h), o(t, n.methods), n.allTransitions().forEach(function(n) {
                t[a(n)] = function() {
                    return this._fsm.fire(n, [].slice.call(arguments))
                }
            }), t._fsm = function() {
                this._fsm = new u(this, n), this._fsm.init(arguments)
            }
        }
        var o = i(0),
            a = i(2),
        ...
        e.version = "3.0.0-rc.1", e.factory = function() {
            var t, n;
            "function" == typeof arguments[0] ? (t = arguments[0], n = arguments[1] || {}) : (t = function() {
                this._fsm.apply(this, arguments)
            }, n = arguments[0] || {});
            var i = new c(n, e);
            return r(t.prototype, i), t.prototype._fsm.config = i, t
        }, e.apply = s, e.defaults = {
            wildcard: "*",
            init: {
                name: "init",
                from: "none"
